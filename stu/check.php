...
<div style=" display: inline-block; width: 100%; background: #474747; padding: 0px 0px 5px 0px;">
    <ul id="menu" style="margin-top: 0px; vertical-align: middle;">
                ...
                <a href="#" class="drop"><span>Admissions </span></a>
                            ...
                            <h3>Admissions</h3>
                            <ul>
                                                                    <li><a href="" ><span>student Details</span></a></li>
																	<li><a href="" ><span>view Attendance</span></a></li>
                                                            </ul>
                        </div>
                                    </div>
            </li>
                ...
                <a href="#" class="drop"><span>Academics</span></a>
                            ...
                            <h3>Acad View</h3>
                            <ul>
                                                                    <li><a href="editschedule.php" ><span>View/edit Schedule</span></a></li>
																	<li><a href="view_tt.php" ><span>Enter Attendance</span></a></li>
                                                            </ul>
                        </div>
                                    </div>
            </li>
...
<?php
	...
	if($level==11)
	{
	$quer=mysql_query("SELECT * FROM student_login WHERE roll_number=$roll") or die(mysql_error());
	if($quer)
	{
		$row=mysql_fetch_array($quer);
		$day=$row['fld'];
		$tday=date('Y-m-d');
		$s=((strtotime($tday)-strtotime($day))/86400);
		if($row['per_flag']!=1)
		{
			if($s<=30)
			{
				$s=30-$s;
				echo"<script>alert(\"You have $s days for entering personal details\");</script>";
				echo "<h1><center><b>You need to enter your personal/academic details in $s days</b></center></h1>";
				echo"<a href=\"admission.php\"><h3><center><b>Enter personal/academic Details</b></center></h3></a><br>";
				echo"<a href=\"viewatt.php\"><h1><center><b>Skip for this time</b></center></h1></a>";
			}
			else
			{
