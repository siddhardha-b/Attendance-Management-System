...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		{
			echo "<h2><center>Email Id cannot be empty</center></h2>";
		}
		else
		{
			$username=$_SESSION['SESS_FIRST_NAME'];
			$em=$_POST['recemail'];
			$queryent="UPDATE student_login SET recemail='$em',recflag='1' WHERE user_name=$username;";
			$resultent=mysql_query($queryent);
			if(!$resultent)
			{
				echo "<h2><center>Unknown Error Encountered</center></h2>";
			}
			else
			{
				echo "<script type=\"text/javascript\">";
				echo "alert(\"Successfully set recovery email address.\")";
				echo "</script>";
...
?>
<h1><center><b>If you forgot your password, it will be sent to the recovery email address provided by you.</b></center></h1>
