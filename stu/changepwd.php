...
if(isset($_POST['Reset_Password']))
{
	...
	$user_name=$_SESSION['SESS_ROLL_NUMBER'];
	$user_name1=substr($user_name,-9);
	$query1="SELECT * FROM student_login WHERE roll_number='$user_name' LIMIT 1";
	...
	if(!$err_flag)
	{
		...
		else
		{
			...
			$querypwd="UPDATE student_login SET password=$password WHERE roll_number='$user_name'";
			...
			{
				echo "<center>Sucessfully changed password</center>";
			}
		}
