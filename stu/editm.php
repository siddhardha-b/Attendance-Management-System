...
<?php
echo "<h1><center><b>Daily attendence details will be sent to this number only.</b></center></h1><br>";
$roll=$_SESSION['SESS_ROLL_NUMBER'];
if($_SESSION['user_level']!=12)
{
exit();
}
$roll1=substr($roll,-12);
$quer="SELECT * FROM student_basic WHERE roll_number='$roll1'";
...
{
	$flg=false;
	echo "<h1><center><b>Mobile number cannot be empty</b></center></h1>";
}
if(strlen($mobile)<10)
{
	$flg=false;
	echo "<h1><center><b>Enter a valid mobile number.</b></center></h1>";
}

if($flg)
{

$quer=mysql_query("UPDATE student_basic SET parent_mobile='$mobile' WHERE roll_number='$roll1'")or die(mysql_error());
if($quer)
{
	echo"<h1><center><b>Successfully Updated.<b></center></h1>";
}
else
{
...
<form id="form1" name="form1" method="post" action="">
  <center><table width="500" border="0" class="inner_table">
    <tr>
