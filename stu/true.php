...
<?php
				echo"<h1><center>Please enter your personal/academic details.Your 30 days time period to enter details have been completed.<br><br>To view your attendance, you need to enter your details.</center></h1>";
?>
 </table>
</div></div></p>
								</div>
