...
$qur="SELECT * FROM faculty_details WHERE faculty_dept='$dep'";
$res=mysql_query($qur) or die(mysql_error());
echo"<table class=\"inner_table1\" border=\"1\">";
echo"<th>Faculty ID</th><th>Department</th><th>Name</th><th>lastname</th><th>Short Form</th><th>Email</th><th>user status</th><th>edit</th>";
...
echo"<tr><td>$roll</td><td>$dep</td><td>$name</td><td>$lastname</td><td>$sfrm</td>";
...
echo "<td>$email</td><td>$stat</td>";
}
else echo"<td></td><td></td>";
echo"<td><a href=\"edit5.php?roll=$roll\">edit</a></td></tr>";
}
