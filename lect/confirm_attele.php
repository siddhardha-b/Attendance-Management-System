...
{echo "<center>";
	...
	if(isset($_POST['submit']))
	{
		...
		if($trans_flag)
		{
			for($x=0;$x<$np;$x++)
			{
				$query="INSERT INTO comp_class_details (date,year,section,period,subject,sub_taught) VALUES('$dmy','$year','$section','$spp','$subject','$sub_taught')";
				$result=mysql_query($query);
				if(!$result)
				{
					//echo "not entered";
