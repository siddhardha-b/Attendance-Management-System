...
if(!isset($_GET['year'])||!isset($_GET['sec'])||!isset($_GET['sp'])||!isset($_GET['np'])||!isset($_GET['no_stu'])						||!isset($_GET['no_pre'])||!isset($_GET['subject'])||!isset($_GET['no_abs']))
{
...
{echo "<center>";
	...
	if(isset($_POST['submit']))
	{
		...
		if(empty($sub_taught))
		{
			...
			echo "alert(\"You need enter topic taught.\")";
			echo "</script>";
			exit();
		}
		for($x=0;$x<$np;$x++)
