...
if($_GET['id']==0)
{
	...
	echo "alert(\"Assigned sucessfully\")";
	echo "</script>";
	echo "<h1><center>Succefully assigned.</center></h1>";
	header("refresh:2;url=fac_det.php");
}
elseif($_GET['id']==1)
{
	echo "query failed.we are redirecting you.";
	header("refresh:2;url=fac_det.php");
}
elseif($_GET['id']==2)
{		
	echo "Already assigned.we are redirecting you.";
	header("refresh:1;url=fac_det.php");
}
?>
