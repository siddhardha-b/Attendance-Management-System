...
if(isset($_POST['submit']))
{
	...
	elseif(!isValidData($year,$section))
	{
		echo "<script type=\"text/javascript\">";
	...
	header("location:enterctt.php?year=$year&section=$section");
}


function isValidData($year,$section)
{
...
<tr><td>section:</td><td><input type="text" name="branch" /></td></tr>
</table>
