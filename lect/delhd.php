...
if(isset($_GET['val']))
{
	...
	if($row=mysql_fetch_array($res))
	{
		...
		$que=mysql_query("UPDATE faculty_login SET user_level='1' WHERE user_name=$roll") or die(mysql_error());
		if($que)
		{	
			echo "<script type=\"text/javascript\">";
			echo "alert(\"Sucessfully deleted HOD\")";
			echo "</script>";
			echo "<h2><center>Sucessfully deleted HOD</center></h2>";
			header("refresh:7;url='delh.php'");
		}
