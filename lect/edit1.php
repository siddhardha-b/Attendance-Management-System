...
echo"<th>Roll no.</th><th>Name</th><th>Email</th><th>status</th><th>join year</th><th>join branch</th><th>current section</th><th>current year</th><th>current sem</th><th>current branch</th><th>Edit</th>";
if($res)
{
...
{
echo "<tr><td>$roll</td><td>".$row1['name']."</td><td>".$row1['student_email']."</td><td>".$row1['user_status']."</td>";
}
else echo"<tr><td>$roll</td><td></td><td></td><td></td>";
$query1="SELECT * FROM student_basic WHERE roll_number=$roll LIMIT 1";
$result1=mysql_query($query1);
if($row2=mysql_fetch_array($result1))
{
echo"<td>".$row2['joining_year']."</td><td>".$row2['join_branch']."</td>";
}
else echo"<td></td><td></td>";
echo"<td>".$row['current_sec']."</td><td>".$row['current_year']."</td><td>".$row['current_sem']."</td><td>".$row['current_branch']."</td>";
echo "<td><a href=\"edit2.php?roll=$roll\">edit</a></td></tr>";
}

echo"</table>";
}
else "<tr>no class found</tr>";
