...
if(isset($_GET['sec_id'])&&isset($_GET['year']))
{
	...
	echo "<td>Elective 1</td>";
	echo "<td>Elective 2</td>";
	echo "<td>Elective 3</td>";
	echo "</tr>";
	if($result)
	{
		if(mysql_num_rows($result)>0)
		{
			...
			{
				$name1=((substr($row['roll_number'],-5)*10)+1);
				$name2=((substr($row['roll_number'],-5)*10)+2);
				$name3=((substr($row['roll_number'],-5)*10)+3);
				$ele1=$row['current_ele1'];
				$ele2=$row['current_ele2'];
				$ele3=$row['current_ele3'];
				echo "<tr>";
				echo "<td>".$row['roll_number']."</td>";
				echo "<td>"."<input type=\"text\" name=\"$name1\" id=\"ele1\" value=\"$ele1\" />"."</td>";
				echo "<td>"."<input type=\"text\" name=\"$name2\" id=\"ele1\" value=\"$ele2\"/>"."</td>";
				echo "<td>"."<input type=\"text\" name=\"$name3\" id=\"ele1\" value=\"$ele3\"/>"."</td>";
				echo "</tr>";
			}
			echo "<tr>";
			echo "<td>&nbsp;</td>";
			echo "<td>&nbsp;</td>";
			echo "<center><td><input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Submit\" /></td></center>";
			echo "<td>&nbsp;</td>";
			echo "</tr>";
			echo "</table>";
			echo "</form>";
...
{
	header("location:electives1.php");
}
?>
