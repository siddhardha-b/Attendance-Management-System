...
$query="SELECT * FROM alert_section WHERE alert_by='$username'";
...
if($result)
{
	if(mysql_num_rows($result)>0)
	{
		...
		{		
			...
			$id1=bin2hex($id1);
			echo "<tr>";
			echo "<td>".$row['alert_subject']."</td>";
			echo "<td>"."<a href=\"view_alrt1.php?id=$id1\">View this alert</a>"."</td>";
			echo "<td>"."<a href=\"dlt_alrt1.php?id=$id1\">Delete this alert</a>"."</td>";
			echo "</tr>";
		}
	}
	else
	{
		echo "<h2><center>No alerts have been generated by you</center></h2>";
	}
}
else
{
	echo "Failed to excute query";
}
?>
