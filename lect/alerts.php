...
<?php
$id1=mcrypt_ecb(MCRYPT_3DES,KEY,"1",MCRYPT_ENCRYPT);
$id1=bin2hex($id1);
$id2=mcrypt_ecb(MCRYPT_3DES,KEY,"2",MCRYPT_ENCRYPT);
$id2=bin2hex($id2);
$id3=mcrypt_ecb(MCRYPT_3DES,KEY,"3",MCRYPT_ENCRYPT);
$id3=bin2hex($id3);
$id4=mcrypt_ecb(MCRYPT_3DES,KEY,"4",MCRYPT_ENCRYPT);
$id4=bin2hex($id4);
$id5=mcrypt_ecb(MCRYPT_3DES,KEY,"5",MCRYPT_ENCRYPT);
$id5=bin2hex($id5);
$id6=mcrypt_ecb(MCRYPT_3DES,KEY,"6",MCRYPT_ENCRYPT);
$id6=bin2hex($id6);
$id7=mcrypt_ecb(MCRYPT_3DES,KEY,"7",MCRYPT_ENCRYPT);
$id7=bin2hex($id7);
$id8=mcrypt_ecb(MCRYPT_3DES,KEY,"8",MCRYPT_ENCRYPT);
$id8=bin2hex($id8);
$id9=mcrypt_ecb(MCRYPT_3DES,KEY,"9",MCRYPT_ENCRYPT);
$id9=bin2hex($id9);
$id10=mcrypt_ecb(MCRYPT_3DES,KEY,"10",MCRYPT_ENCRYPT);
$id10=bin2hex($id10);
if($_SESSION['user_level']==3)
{
	echo "<a href=\"gen_alrt.php?to_type=$id1\"><h3><center>Genereate an alert to HOD's of all branches</h3></a><br/>";//1
	echo "<a href=\"disp_hod.php?to_type=$id2\"><h3><center>Genreate an alert to a particular HOD</h3></a><br/>";//2
	echo "<a href=\"gen_alrt.php?to_type=$id3\"><h3><center>Generate an alert to all faculty</h3></a><br/>";//3
	echo "<a href=\"disp_branch.php?to_type=$id4\"><h3><center>Generate an alert to faculty department wise</h3></a><br/>";//4
	echo "<a href=\"sel_branch.php?to_type=$id5\"><h3><center>Generate an alert to particular faculty</h3></a><br/>";//5
	echo "<a href=\"gen_alrt.php?to_type=$id6\"><h3><center>Generate an alert to all students</h3></a><br/>";//6
	echo "<a href=\"disp_branch.php?to_type=$id7\"><h3><center>Generate an alert to particular branch students</h3></a><br/>";//7
	echo "<a href=\"sel_sec.php?to_type=$id8\"><h3><center>Generate an alert to particular section students</h3></a><br/>";//8
	echo "<a href=\"sel_stu1.php?to_type=$id9\"><h3><center>Generate an alert to particular student</h3></a><br/>";//9
}
