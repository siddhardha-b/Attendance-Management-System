...
<?php
 ...
 $query="SELECT * FROM faculty_login WHERE user_level='3'";
$res=mysql_query($query) or die(mysql_error());

echo " <table class=\"inner_table1\" >";
echo "<tr><td><b>id</b></td><td><b>name</b></td><td><b>last name</b></td><td><b>delete</b></td></tr>";
while($row=mysql_fetch_array($res))
{
$id=$row['user_name'];
$name=$row['name'];
$lname=$row['last_name'];
echo "<tr><td>$id</td><td>$name</td><td>$lname</td><td><a href=\"delpd.php?val=$id\">delete</a></td></tr>";
}
